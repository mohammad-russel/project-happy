...
<head>
    ...
    <link rel="stylesheet" href="../sr/css/main.css">
...
<body class="sm:bg-[#f4f9ff] sm:h-screen sm:flex sm:justify-center sm:items-center">
    <div class="sm:shadow-[0_20px_50px_-20px_rgba(0,26,130,0.21)] bg-white sm:w-[380px] mx-auto p-4 sm:p-6 sm:border-[6px] sm:border-[#f4f9ff] sm:min-h-[770px] sm:rounded-3xl">
        ...
        <div class="mb-12 text-center">
            <h1 class="relative text-3xl font-bold text-[#222950]">Happy <span class="rounded-lg border border-blue-200 px-2 text-base font-semibold text-blue-500 shadow-md shadow-blue-950/5">Management</span>
            </h1>
        </div>
        <div class="">
            <form class="flex flex-col gap-4" action="home.html" method="#">
                <div class="relative">
