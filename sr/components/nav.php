<div class="flex fixed lg:absolute bottom-0 bg-white w-full left-0 px-10 justify-between py-4 rounded-t-3xl shadow-[0_-5px_50px_0px_rgba(0,45,94,0.12)]">
    <a href="dashboard" class="w-[50px] h-[50px] rounded-xl bg-[#F7FAFE] flex justify-center items-center group hover:bg-blue-500 tran">
        <svg class="stroke-[#0472ED] w-6 stroke-[1.5px] tran group-hover:stroke-white" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <a href="scan" class="w-[50px] h-[50px] rounded-xl bg-[#F7FAFE] flex justify-center items-center group hover:bg-blue-500 tran">
    ...
    <a href="retailer" class="w-[50px] h-[50px] rounded-xl bg-[#F7FAFE] flex justify-center items-center group hover:bg-blue-500 tran">
        <svg class="stroke-[#4E5D78] w-6 stroke-[1.5px] tran group-hover:stroke-white" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
            <g id="SVGRepo_iconCarrier">
